    ...
    <div className='container mx-auto px-3 my-10'>
        ...
        <div className='relative'>
          ...
          <div className='absolute top-0 hidden lg:flex justify-between w-full h-full items-center'>
            <button onClick={handelPrev} className='bg-white text-black rounded-full -ml-2 z-10 p-1'><FaAngleLeft/></button>
            <button onClick={handelNext} className='bg-white text-black rounded-full -mr-2 z-10 p-1'><FaAngleRight/></button>
          </div>
        </div>
      </div>
  )
